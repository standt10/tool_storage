...

{
    ...
    function adjustFontSize(element) {
        ...
        // 探索範囲
        let low = 1;
        let high = Math.max(256, maxWidth, maxHeight);
    ...
    function AdjustStringSize() {
        ...
        // adjust / set / action ボタン
        const elements1 = document.querySelectorAll(".setBtn, .actionBtn");
        ...
        actionButtons.forEach(button => {
            const fontSize =
                parseFloat(window.getComputedStyle(button).fontSize);
    ...
    function ClickStart() {
        if (start.textContent === "スタート") {
            ...
            const buttons3 =
                document.querySelectorAll(".adjBtnGroup");
            ...
            if (
                ...
                if (state !== "countdown") {
                    state = "countdown";
                    elapsedMs =
                        timeToMilliSec(timer.textContent);
                    totalMs = elapsedMs;
                }
                ...
                timerID = setInterval(() => {
                    ...
                    if (elapsedMs <= 0) {
                        ...
                        const alarm = audioFiles[audioNum];
                        alarm.currentTime = 0;
                        alarm.play();
                        alarm.play();
                        ...
                        const buttons =
                            document.querySelectorAll(".setBtn.hidden");
                        ...
                        const buttons2 =
                            document.querySelectorAll(".actionBtn.hidden");
                    ...
                    timer.textContent =
                        timeToString(
                            roundUpToNearestThousand(elapsedMs)
                        );
    ...
    function ClickSet(timeText) {
        ...
        const buttons =
            document.querySelectorAll(".setBtn");
